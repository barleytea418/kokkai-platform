...
　政府は今回も給付金という形での対策を講じておりますが、根本的な物価高の原因に対処できていないのではないでしょうか。エネルギー価格の高騰は国際要因だけでなく、政府のエネルギー政策の失敗によるものでもあります...`,
    speakers: [
      ...
      { name: '石破茂', party: '自由民主党', position: '内閣総理大臣', speechCount: 5 },
      { name: '岡田克也', party: '立憲民主党', position: '代表', speechCount: 4 },
      { name: '馬場伸幸', party: '日本維新の会', position: '代表', speechCount: 3 },
      { name: '山口那津男', party: '公明党', position: '代表', speechCount: 2 },
    ],
    keywords: ['補正予算', '物価対策', '給付金', 'エネルギー', '賃金'],
    sourceUrl: 'https://www.shugiin.go.jp/internet/itdb_kaigiroku.nsf/',
    youtubeVideoId: 'dQw4w9WgXcQ',
    votes: { yes: 281, no: 153, abstain: 5, passed: true },
  },
  {
    id: 'rec-002',
    house: 'shugiin',
...
○防衛大臣（木原稔君）　防衛力の抜本的強化については、歳出改革、決算剰余金の活用、防衛力強化資金などを財源として確保することとしております。増税については、2027年度以降において、法人税、所得税、たばこ税の税制措置を予定しており...`,
    speakers: [
      { name: '西村康稔', party: '自由民主党', position: '委員長', speechCount: 12 },
      { name: '辻元清美', party: '立憲民主党', position: '委員', speechCount: 8 },
      { name: '木原稔', party: '自由民主党', position: '防衛大臣', speechCount: 6 },
      { name: '鈴木俊一', party: '自由民主党', position: '財務大臣', speechCount: 5 },
      { name: '足立康史', party: '日本維新の会', position: '委員', speechCount: 4 },
    ],
...
○厚生労働大臣（武見敬三君）　後期高齢者医療制度については、団塊の世代が後期高齢者となる中、現役世代の負担増を抑制しつつ、医療・介護保険の持続可能性を確保することが重要です。一定所得以上の方に応分の負担をお願いしていますが、必要な医療へのアクセスが阻害されないよう十分に配慮してまいります...`,
    speakers: [
      { name: '加藤勝信', party: '自由民主党', position: '委員長', speechCount: 10 },
      { name: '田村智子', party: '日本共産党', position: '委員', speechCount: 6 },
      { name: '武見敬三', party: '自由民主党', position: '厚生労働大臣', speechCount: 7 },
      { name: '塩村文夏', party: '立憲民主党', position: '委員', speechCount: 5 },
    ],
...
○デジタル大臣（河野太郎君）　ただいま議題となりましたデジタル行財政改革関連4法案について御説明申し上げます。
...
○山本太郎君（れいわ新選組）　デジタル化は便利な一面がありますが、デジタルデバイドの問題を無視することはできません。高齢者や障害者、外国人など、デジタルにアクセスしにくい方々への配慮はどのようにお考えですか？`,
    speakers: [
      ...
      { name: '河野太郎', party: '自由民主党', position: 'デジタル大臣', speechCount: 6 },
      { name: '山本太郎', party: 'れいわ新選組', position: '議員', speechCount: 5 },
      { name: '蓮舫', party: '立憲民主党', position: '議員', speechCount: 4 },
    ],
...
○上田清司君（立憲民主党）　台湾有事が現実の問題として議論されるようになってきましたが、日本はどう対処するのですか。外務大臣、お答えください。

○外務大臣（上川陽子君）　台湾をめぐる情勢は厳しさを増しており、台湾海峡の平和と安定は、わが国のみならず国際社会全体にとって不可欠です。日米同盟を基軸としつつ、外交的手段による問題解決を最優先としてまいります。台湾との非政府間の実務関係は維持・強化していきます...`,
    speakers: [
      { name: '佐藤正久', party: '自由民主党', position: '委員長', speechCount: 11 },
      { name: '上田清司', party: '立憲民主党', position: '委員', speechCount: 7 },
      { name: '上川陽子', party: '自由民主党', position: '外務大臣', speechCount: 8 },
      { name: '浜田靖一', party: '自由民主党', position: '防衛大臣', speechCount: 6 },
    ],
...
○枝野幸男君（立憲民主党）　半導体の国産化支援について、これまでの公的資金投入の効果をどう評価していますか。

○経済産業大臣（齋藤健君）　ラピダスへの支援を含め、先端半導体の国産化は日本の経済安全保障上極めて重要です。初期段階での公的支援は不可欠であり、民間投資を呼び込む呼び水効果も期待できます。2ナノメートル以下の先端品を2027年に量産開始する計画で、順調に進んでいます...`,
    speakers: [
      { name: '梶山弘志', party: '自由民主党', position: '委員長', speechCount: 9 },
      { name: '枝野幸男', party: '立憲民主党', position: '委員', speechCount: 6 },
      { name: '齋藤健', party: '自由民主党', position: '経済産業大臣', speechCount: 7 },
      { name: '片山虎之助', party: '日本維新の会', position: '委員', speechCount: 4 },
    ],
